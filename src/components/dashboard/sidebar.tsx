...
import { LayoutDashboard, Users, UserCircle, Briefcase, MessageSquare, Brain, LogOut, Settings } from 'lucide-react';
...
const navItems: NavItem[] = [
  { href: '/dashboard/investor', label: 'Investor Dashboard', icon: LayoutDashboard, roles: ['investor'] },
  { href: '/dashboard/entrepreneur', label: 'Entrepreneur Dashboard', icon: LayoutDashboard, roles: ['entrepreneur'] },
...
export default function Sidebar() {
  ...
  const dynamicDashboardItem: NavItem = {
    href: dashboardLink,
    label: userRole === 'investor' ? 'Investor Dashboard' : 'Entrepreneur Dashboard',
  ...
  const displayNavItems = [
    ...
    ...navItems.filter(item => item.href !== '/dashboard/investor' && item.href !== '/dashboard/entrepreneur' && (!item.roles || item.roles.includes(userRole!)))
  ];
